...
def start(update: Update, context: CallbackContext) -> None:
    reply_text = "Hi! This is the Daily News Bot."
...
def received_information(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_text(
        "Here's the Joke. I've just got first place in a national bullshitting competition. Well, I actually came 12th.To be honest, there wasn't even a competition."
...
def main():
    ...
    updater = Updater("1477854286:AAGnIB-TG8RgcznVyoA3eIocyIc55wpMA8g", persistence=pp, use_context=True)
