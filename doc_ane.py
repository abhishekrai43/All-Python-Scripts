...
def get_docs(base_url):
    ...
    for i in range(len(links)):
        try:
            ...
            with open('Doc_Hematology.csv', 'a+', encoding='utf-8') as f:
...
burl = 'https://www.doximity.com/directory/md/specialty/oncology?after=pub%2Falan-wan-do'
g = get_docs(burl)
z = 0
while True:
    sleep(randint(10, 100))
    p_url = str(g[-1])
    url = 'https://www.doximity.com/directory/md/specialty/hematology?after=' + p_url[1:]
    print(url)
    g = get_docs(url)
